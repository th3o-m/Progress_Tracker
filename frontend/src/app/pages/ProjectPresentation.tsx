...
export function ProjectPresentation({ projectId }: { projectId: string }) {
  ...
  const slides = [
    ...
    { title: "Project Objectives", eyebrow: "Purpose", content: <div className="max-w-4xl"><p className="text-2xl leading-9 text-slate-700">{data.project.objectives || "No objectives recorded yet."}</p></div> },
