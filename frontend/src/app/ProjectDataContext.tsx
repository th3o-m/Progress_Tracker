...
export interface Challenge { id: string; activity_id: string; challenge_type: string; description: string; mitigation_plan: string | null; resolved: boolean; created_at: string; }
