...
alter table public.project_report_imports
  ...
  add column if not exists review_status text default 'imported',
...
alter table public.project_report_imports
  ...
  alter column import_status set default 'completed',
  alter column raw_preview_json set default '{}'::jsonb,
  alter column milestones set default '{}',
  alter column review_status set default 'imported';
